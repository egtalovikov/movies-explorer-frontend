    ...
    <section className="portfolio">
      ...
      <ul className="list">
        <li className="portfolio__item">
          <a
            href="https://egtalovikov.github.io/how-to-learn/"
            target="_blank"
            rel="noopener noreferrer"
            className="portfolio__item-container links"
          >
        ...
        <li className="portfolio__item">
          <a
            href="https://egtalovikov.github.io/russian-travel/"
            target="_blank"
            rel="noopener noreferrer"
            className="portfolio__item-container links"
          >
        ...
        <li className="portfolio__item">
          <a
            href="https://mesto.egtalovikov.nomoredomainsclub.ru/"
            target="_blank"
            rel="noopener noreferrer"
            className="portfolio__item-container links"
          >
